...
exports.PayRunsController = void 0;
const PayRunsService_1 = require("../services/PayRunsService");
const service = new PayRunsService_1.PayRunsService();
class PayRunsController {
    async generateMonthlyPayRuns(req, res) {
        try {
            const user = req.user;
...
exports.PayRunsController = PayRunsController;
//# sourceMappingURL=PayRunsController.js.map