...
export declare class PayslipService {
    ...
    update(id: number, data: Partial<any>): Promise<{
        id: number;
        createdAt: Date;
        updatedAt: Date;
        status: import("@prisma/client").$Enums.StatusPayslip;
    ...
    updateStatus(id: number, status: StatusPayslip, user: Users): Promise<{
        id: number;
        createdAt: Date;
        updatedAt: Date;
        status: import("@prisma/client").$Enums.StatusPayslip;
    ...
    generateMonthlyPayslips(entrepriseId: number, periode?: string): Promise<{
        payRun: {
            id: number;
            createdAt: Date;
            updatedAt: Date;
